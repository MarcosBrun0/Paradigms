...
function Evento1()
messagebox('Voce escolheu a cor Vermelha','UENF Scilab 2024  Radiobutton')
set(findobj("tag", "Radio2") , "value", 0);
endfunction;

function Evento2()
messagebox('Voce escolheu a cor Verde','UENF 2024 Radiobutton')
